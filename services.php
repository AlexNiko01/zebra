<?php include('header.php') ?>
    ...
    <main>
        <section class="slider-parent">
            ...
            <div class="main-slider">
                <div class="main-slider__slide">
                    <div class="main-slider__img main-slider__img--services"
                         style="background-image: url(img/serv-s.png)"></div>
                </div>
                <div class="main-slider__slide">
                    <div class="main-slider__img main-slider__img--services"
                         style="background-image: url(img/serv-s.png)"></div>
        ...
        <section class="production">
            <div class="grid">
                <div class="col-33 tiles__column  tiles__item product">
                    <div class="tiles__img" style="background-image: url('img/p1.png')"></div>
                    <div class="product__hover">
                        <div class="product__content">
                            <h4 class="product__title">CREATIVE PRODUCTION SERVICES</h4>
                            <h3 class="product__sub-title">Design & Print</h3>
                        </div>
                    </div>
                </div>
                <div class="col-33 tiles__column  tiles__item product">
                    <div class="tiles__img" style="background-image: url('img/p2.png')"></div>
                    <div class="product__hover">
                        <div class="product__content">
                            <h4 class="product__title">CREATIVE PRODUCTION SERVICES</h4>
                            <h3 class="product__sub-title">Design & Print</h3>
                ...
                <div class="col-33 tiles__column  tiles__item product">
                    <div class="tiles__img" style="background-image: url('img/p3.png')"></div>
                    <div class="product__hover">
                        <div class="product__content">
                            <h4 class="product__title">CREATIVE PRODUCTION SERVICES</h4>
                            <h3 class="product__sub-title">Design & Print</h3>
            ...
            <div class="grid">
                <div class="col-33 tiles__column  tiles__item product">
                    <div class="tiles__img" style="background-image: url('img/p4.png')"></div>
                    <div class="product__hover">
                        <div class="product__content">
                            <h4 class="product__title">CREATIVE PRODUCTION SERVICES</h4>
                            <h3 class="product__sub-title">Design & Print</h3>
                ...
                <div class="col-33 tiles__column  tiles__item product">
                    <div class="tiles__img" style="background-image: url('img/p6.png')"></div>
                    <div class="product__hover">
                        <div class="product__content">
                            <h4 class="product__title">CREATIVE PRODUCTION SERVICES</h4>
                            <h3 class="product__sub-title">Design & Print</h3>
        ...
        <section class="see-production">
            <div class="text-center">
                <a href="#" class="button">PRODUCTION</a>
            </div>
        </section>
