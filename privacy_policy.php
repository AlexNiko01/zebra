...
<main class="privacy-policy">
    <div class="row">
        <div class="column">
            <div class="career__titles has-bottom-border">
                <h3 class="career__title">PRIVACY POLICY</h3>
                <h4 class="career__sub-title">ZEBRA WORLDWIDE</h4>
            </div>
            <div class="row">
                <div class="column small-12 medium-6 wow fadeInUp">
                    <h3>What is this Privacy Policy for?</h3>
                    <p>This privacy policy is for this website: www.zebra-worldwide.com and served by Zebra
                        Worldwide and governs the privacy of its users who choose to use it.</p>
                ...
                <div class="column small-12 medium-6 wow fadeInUp">
                    ...
                    <p>This website and its owners take a proactive approach to user privacy and ensure the
                        ...
                        experience. This website complies to all UK national laws and requirements for user privacy.
                    </p>
                </div>
                <div class="column small-12 medium-6 wow fadeInUp">
                    ...
                    <p>Cookies are small files saved to the user’s computers hard drive that track, save and store
                        ...
                        through its server to provide the users with a tailored experience within this website.</p>
                    <p>Users are advised that if they wish to deny the use and saving of cookies from this website
                    ...
                    <p>This website uses tracking software to monitor its visitors to better understand how they use
                        it. This software is provided by Google Analytics which uses cookies to track visitor usage.
                        The software will save a cookie to your computers hard drive in order to track and monitor
                        your engagement and usage of the website, but will not store, save or collect personal
                        information. You can read Google’s privacy policy here for further information
                        www.google.com/privacy.html.
                    </p>
                    <p>Other cookies may be stored to your computers hard drive by external vendors when this
