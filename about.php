<?php include('header.php'); ?>
    ...
    <section class="about-slider">
        <div class="about-slider__slide">
            <div style="background-image: url(img/portrait1.png)" class="about-slider__img">
                    ...
                    <div class="row">
                        <div class="column small-12 medium-6">
                            <p>Lorem do dolor amet ipsum dolor sit amet, consectetur
                                ...
                                tempor
                                incididunt ut labore sed temp du tempor do eiusmod et dolore magna aliqua.Lorem elit sit
                                do
